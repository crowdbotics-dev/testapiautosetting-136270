"""
Django settings for testapiautosetting_136270 project.
...
ROOT_URLCONF = 'testapiautosetting_136270.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136270.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsqvl5j Support <support@testapiautosetting-136270.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136270 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136270 App",
    "VERSION": "v1",
}
